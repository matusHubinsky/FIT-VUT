...
void drawInject(GPUContext&ctx,uint32_t n){
...
void testLambert(
    ...
    float           doubleSided,
    glm::vec3 const&cam        ){
  auto expected = computeExpectedColor(pos,nor,coord,light,diffC,aF,tex,isT,doubleSided,cam);
  auto color    = computeColor(pos,nor,coord,light,diffC,tex,isT,doubleSided,cam);
  ...
  auto printInfo = [&](){
    ...
    uniforms.uniform[4].v3 - pozice kamery
    uniforms.uniform[5].v4 - difuzní barva materialu, - pokud není textura
    uniforms.uniform[6].v1 - 0.f znamená, že není textura, 1.f znamená, že je textura
    uniforms.uniform[7].v1 - 0.f znamená, že je to jednostraný povrch, 1.f znamená, že je to doubleSided
...
SCENARIO("37"){
  ...
  for(uint32_t f=0;f<2;++f){//flip normal
    ...
    for(uint32_t d=0;d<2;++d){
      ...
      for(uint32_t i=0;i<2;++i){//isTexture
        testLambert(glm::vec3(0.f),flip*glm::vec3(0,1,0),glm::vec2(0.3,0.6),glm::vec3(0,1,0),
            glm::vec4(.5),aF,textures[i],(float)i,doubleSided,glm::vec3(0.f,1.f,0.f));

        testLambert(glm::vec3(0.f),flip*glm::vec3(0,1000,0),glm::vec2(0.2,0.8),glm::vec3(0,1,0),
            glm::vec4(.5),aF,textures[i],(float)i,doubleSided,glm::vec3(0.f,1.f,0.f));

        testLambert(glm::vec3(0.f),flip*glm::vec3(0,1,0),glm::vec2(0.5,0.5),glm::vec3(0,1000,0),
            glm::vec4(.5),aF,textures[i],(float)i,doubleSided,glm::vec3(0.f,1.f,0.f));

        testLambert(glm::vec3(0.f),flip*glm::vec3(0,1000,0),glm::vec2(0.2,0.6),glm::vec3(0,1000,0),
            glm::vec4(.5),aF,textures[i],(float)i,doubleSided,glm::vec3(0.f,1.f,0.f));

        testLambert(glm::vec3(0,-1.f,0),flip*glm::vec3(0,1,0),glm::vec2(0.9,0.1),glm::vec3(0,0,0),
            glm::vec4(.5),aF,textures[i],(float)i,doubleSided,glm::vec3(0.f,1.f,0.f));

        testLambert(glm::vec3(0,0.f,0),flip*glm::vec3(1,0,0),glm::vec2(0.55,0.45),glm::vec3(0,1,0),
            glm::vec4(.5),aF,textures[i],(float)i,doubleSided,glm::vec3(1.f,0.f,0.f));

        testLambert(glm::vec3(0,0.f,0),flip*glm::vec3(0,-1,0),glm::vec2(0.45,0.55),glm::vec3(0,1,0),
            glm::vec4(.5),aF,textures[i],(float)i,doubleSided,glm::vec3(0.f,-1.f,0.f));
